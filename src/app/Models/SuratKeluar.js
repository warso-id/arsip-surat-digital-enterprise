// SuratKeluar.js - Surat Keluar Model
class SuratKeluar {
    constructor() {
    ...
    async all(page = 1, limit = 10, orderBy = 'tanggal_surat', order = 'DESC') {
        try {
    ...
    async findByNoSurat(noSurat) {
        try {
            ...
            console.error('Find by no surat error:', error);
            return null;
        }
    }
